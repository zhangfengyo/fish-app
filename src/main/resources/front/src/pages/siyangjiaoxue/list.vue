		...
		<div class="list-preview">
			...
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item" >
					<div class="lable">鏁欏鏍囬锛?/div>
					<el-input v-model="formSearch.jiaoxuebiaoti" placeholder="鏁欏鏍囬" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item" >
				...
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('siyangjiaoxue','鏂板')" type="primary" @click="add('/index/siyangjiaoxueAdd')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.jiaoxuebiaoti != ''&&this.formSearch.jiaoxuebiaoti != undefined) searchWhere.jiaoxuebiaoti = '%' + this.formSearch.jiaoxuebiaoti + '%';
				...
				this.$http.get(`siyangjiaoxue/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/siyangjiaoxueDetail', query: params});
			},
