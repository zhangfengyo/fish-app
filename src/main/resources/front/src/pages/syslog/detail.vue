		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">鐢ㄦ埛鎿嶄綔</div>
						<div class="text "  >{{detail.operation}}</div>
					</div>
					<div class="item">
						<div class="lable">璇锋眰鏂规硶</div>
						<div class="text "  >{{detail.method}}</div>
					</div>
					<div class="item">
						<div class="lable">璇锋眰鍙傛暟</div>
						<div class="text "  >{{detail.params}}</div>
					</div>
					<div class="item">
						<div class="lable">璇锋眰鏃堕暱(姣)</div>
						<div class="text "  >{{detail.time}}</div>
					</div>
					<div class="item">
						<div class="lable">IP鍦板潃</div>
						<div class="text "  >{{detail.ip}}</div>
					</div>
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('syslog','淇敼')" @click="editClick">淇敼</el-button>
						<el-button class="delBtn" v-if="btnAuth('syslog','鍒犻櫎')" @click="delClick">鍒犻櫎</el-button>
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 鍒犻櫎
			async delClick(){
				await this.$confirm('鏄惁鍒犻櫎姝ょ郴缁熸棩蹇楋紵') .then(_ => {
