		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">鎬у埆</div>
						<div class="text "  >{{detail.xingbie}}</div>
					</div>
					<div class="item">
						<div class="lable">韬唤璇?/div>
						<div class="text "  >{{detail.idcard}}</div>
					</div>
					<div class="item">
						<div class="lable">骞撮緞</div>
						<div class="text "  >{{detail.age}}</div>
					</div>
					<div class="item">
						<div class="lable">鎵嬫満鍙?/div>
						<div class="text "  >{{detail.shoujihao}}</div>
					</div>
					<div class="item">
						<div class="lable">閭</div>
						<div class="text "  >{{detail.email}}</div>
					</div>
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('yonghu','淇敼')" @click="editClick">淇敼</el-button>
						<el-button class="delBtn" v-if="btnAuth('yonghu','鍒犻櫎')" @click="delClick">鍒犻櫎</el-button>
						<el-button class="editBtn" @click="allchapterClick()" type="warning" v-if="btnAuth('yonghu','绔犺妭绠＄悊')">绔犺妭绠＄悊</el-button>
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 鍒犻櫎
			async delClick(){
				await this.$confirm('鏄惁鍒犻櫎姝ょ敤鎴凤紵') .then(_ => {
