		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('chargerecord','鏂板')" type="primary" @click="add('/index/chargerecordAdd')">
			...
			<div class="list">
				<el-table class="tables" :stripe='false'
					...
					<el-table-column :resizable='true' :sortable='false' prop="username" label="鐢ㄦ埛鍚?></el-table-column>
					<el-table-column :resizable='true' :sortable='false' prop="role" label="瑙掕壊"></el-table-column>
					<el-table-column :resizable='true' :sortable='false' prop="amount" label="閲戦"></el-table-column>
					<el-table-column :resizable='true' :sortable='false' prop="addtime" label="鍏呭€兼椂闂?></el-table-column>
				</el-table>
			</div>
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`chargerecord/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
