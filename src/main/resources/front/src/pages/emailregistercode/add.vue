...
<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="楠岃瘉鐮? prop="code">
				<el-input v-model="ruleForm.code" 
					placeholder="楠岃瘉鐮? clearable :readonly="ro.code"></el-input>
			</el-form-item>
...
<script>
	export default {
		...
		methods: {
			...
			// 澶氱骇鑱斿姩鍙傛暟
			async info() {
				await this.$http.get(`emailregistercode/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
