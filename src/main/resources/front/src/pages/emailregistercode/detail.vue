		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">瑙掕壊</div>
						<div class="text "  >{{detail.role}}</div>
					</div>
					<div class="item">
						<div class="lable">楠岃瘉鐮?/div>
						<div class="text "  >{{detail.code}}</div>
					</div>
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('emailregistercode','淇敼')" @click="editClick">淇敼</el-button>
						<el-button class="delBtn" v-if="btnAuth('emailregistercode','鍒犻櫎')" @click="delClick">鍒犻櫎</el-button>
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 鍒犻櫎
			async delClick(){
				await this.$confirm('鏄惁鍒犻櫎姝ら偖绠遍獙璇佺爜锛?) .then(_ => {
