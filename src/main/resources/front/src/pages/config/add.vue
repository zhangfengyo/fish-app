...
<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="200px"
			>
			<el-form-item class="add-item" label="鍚嶇О" prop="name">
				<el-input v-model="ruleForm.name" 
					placeholder="鍚嶇О" clearable :readonly="ro.name"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="鍊? v-if="type!='cross' || (type=='cross' && !ro.value)" prop="value">
				<file-upload
					tip="鐐瑰嚮涓婁紶鍊?
					action="file/upload"
					:limit="3"
			...
			<el-form-item class="add-item" v-else label="鍊? prop="value">
			...
			<el-form-item class="add-item" label="绫诲瀷" prop="type">
				<el-input v-model.number="ruleForm.type" 
					placeholder="绫诲瀷" clearable :readonly="ro.type"></el-input>
			</el-form-item>
