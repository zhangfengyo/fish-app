		...
		<el-form
			...
			<el-form-item class="add-item" label="鍟嗗搧鍒嗙被" prop="shangpinfenlei">
				<el-input v-model="ruleForm.shangpinfenlei" 
					placeholder="鍟嗗搧鍒嗙被" clearable :readonly="ro.shangpinfenlei"></el-input>
			</el-form-item>
...
<script>
	export default {
		...
		methods: {
			...
			// 澶氱骇鑱斿姩鍙傛暟
			async info() {
				await this.$http.get(`shangpinfenlei/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
