		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item" >
					<div class="lable">鍟嗗搧鍒嗙被锛?/div>
					<el-input v-model="formSearch.shangpinfenlei" placeholder="鍟嗗搧鍒嗙被" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('shangpinfenlei','鏂板')" type="primary" @click="add('/index/shangpinfenleiAdd')">
				...
				<el-table class="tables" :stripe='false'
					...
					<el-table-column width="300" label="鎿嶄綔">
						<template slot-scope="scope">
							...
							<el-button class="table-btn5" type="success" @click.native="chapterClick(scope.row)" v-if="btnAuth('shangpinfenlei','绔犺妭绠＄悊')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.shangpinfenlei != ''&&this.formSearch.shangpinfenlei != undefined) searchWhere.shangpinfenlei = '%' + this.formSearch.shangpinfenlei + '%';
				let user = JSON.parse(localStorage.getItem('sessionForm'))
				if (this.sortType) searchWhere.sort = this.sortType
				if (this.sortOrder) searchWhere.order = this.sortOrder
				this.$http.get(`shangpinfenlei/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
			...
			chapterClick (row){
				...
				this.$router.push({path: '/index/chaptershangpinfenlei', query: params});
			},
		}
	}
</script>
