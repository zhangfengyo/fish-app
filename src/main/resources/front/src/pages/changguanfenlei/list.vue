		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item" >
					...
					<el-input v-model="formSearch.changguanfenlei" placeholder="鍦洪鍒嗙被" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('changguanfenlei','鏂板')" type="primary" @click="add('/index/changguanfenleiAdd')">
				...
				<el-table class="tables" :stripe='false'
					...
					<el-table-column width="300" label="鎿嶄綔">
						<template slot-scope="scope">
							...
							<el-button class="table-btn5" type="success" @click.native="chapterClick(scope.row)" v-if="btnAuth('changguanfenlei','绔犺妭绠＄悊')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`changguanfenlei/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/changguanfenleiDetail', query: params});
			},
