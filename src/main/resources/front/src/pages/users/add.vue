...
<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="瀵嗙爜" prop="password">
				<el-input v-model="ruleForm.password" 
					placeholder="瀵嗙爜" clearable :readonly="ro.password"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="瑙掕壊" prop="role">
				<el-input v-model="ruleForm.role" 
					placeholder="瑙掕壊" clearable :readonly="ro.role"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="澶村儚" v-if="type!='cross' || (type=='cross' && !ro.image)" prop="image">
				<file-upload
					tip="鐐瑰嚮涓婁紶澶村儚"
					action="file/upload"
					:limit="3"
			...
			<el-form-item class="add-item" v-else label="澶村儚" prop="image">
