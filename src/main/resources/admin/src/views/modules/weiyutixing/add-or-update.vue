...
<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="鐢ㄦ埛璐﹀彿" prop="yonghuzhanghao" >
					<el-input v-model="ruleForm.yonghuzhanghao" placeholder="鐢ㄦ埛璐﹀彿" clearable  :readonly="ro.yonghuzhanghao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鐢ㄦ埛璐﹀彿" prop="yonghuzhanghao" >
					<el-input v-model="ruleForm.yonghuzhanghao" placeholder="鐢ㄦ埛璐﹀彿" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="鐢ㄦ埛濮撳悕" prop="yonghuxingming" >
					<el-input v-model="ruleForm.yonghuxingming" placeholder="鐢ㄦ埛濮撳悕" clearable  :readonly="ro.yonghuxingming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鐢ㄦ埛濮撳悕" prop="yonghuxingming" >
					<el-input v-model="ruleForm.yonghuxingming" placeholder="鐢ㄦ埛濮撳悕" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="鎻愰啋鏍囬" prop="tixingbiaoti" >
					<el-input v-model="ruleForm.tixingbiaoti" placeholder="鎻愰啋鏍囬" clearable  :readonly="ro.tixingbiaoti"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鎻愰啋鏍囬" prop="tixingbiaoti" >
					<el-input v-model="ruleForm.tixingbiaoti" placeholder="鎻愰啋鏍囬" readonly></el-input>
				</el-form-item>
				<el-form-item class="date" v-if="type!='info'" label="鎻愰啋鏃ユ湡" prop="tixingriqi" >
					<el-date-picker
				...
				<el-form-item class="input" v-else-if="ruleForm.tixingriqi" label="鎻愰啋鏃ユ湡" prop="tixingriqi" >
					<el-input v-model="ruleForm.tixingriqi" placeholder="鎻愰啋鏃ユ湡" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="鎻愰啋鍐呭" prop="tixingneirong" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.tixingneirong" label="鎻愰啋鍐呭" prop="tixingneirong"  class="textBox">
			...
			async onSubmit() {
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `weiyutixing/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.weiyutixingCrossAddOrUpdateFlag = false;
											this.parent.search();
										}
									});
								} else {
