...
<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="甯栧瓙鏍囬" prop="title" >
					<el-input v-model="ruleForm.title" placeholder="甯栧瓙鏍囬" clearable  :readonly="ro.title"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="甯栧瓙鏍囬" prop="title" >
					<el-input v-model="ruleForm.title" placeholder="甯栧瓙鏍囬" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="select" v-if="type!='info'"  label="鐘舵€? prop="isdone" >
					<el-select :disabled="ro.isdone" v-model="ruleForm.isdone" placeholder="璇烽€夋嫨鐘舵€?  filterable>
						<el-option
				...
				<el-form-item v-else class="input" label="鐘舵€? prop="isdone" >
					<el-input v-model="ruleForm.isdone"
						placeholder="鐘舵€? readonly></el-input>
				</el-form-item>
				<el-form-item class="date" v-if="type!='info'" label="缃《鏃堕棿" prop="toptime" >
					<el-date-picker
				...
				<el-form-item class="input" v-else-if="ruleForm.toptime" label="缃《鏃堕棿" prop="toptime" >
					<el-input v-model="ruleForm.toptime" placeholder="缃《鏃堕棿" readonly></el-input>
				</el-form-item>
				<el-form-item class="upload" v-if="type!='info' && !ro.cover" label="灏侀潰" prop="cover" >
					<file-upload
						tip="鐐瑰嚮涓婁紶灏侀潰"
						action="file/upload"
						:limit="3"
				...
				<el-form-item class="upload" v-else-if="ruleForm.cover" label="灏侀潰" prop="cover" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="鏄惁鍖垮悕" prop="isanon">
					<el-select v-model="ruleForm.isanon" placeholder="鏄惁鍖垮悕">
						<el-option label="鏄? :value="1"></el-option>
						<el-option label="鍚? :value="0"></el-option>
					</el-select>
				</el-form-item>
				<el-form-item v-else class="input" label="鏄惁鍖垮悕" prop="isanon" >
					{{ruleForm.isanon==1?'鏄?:'鍚?}}
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="鏄惁鍒犻櫎" prop="delflag">
					<el-select v-model="ruleForm.delflag" placeholder="鏄惁鍒犻櫎">
						<el-option label="鏄? :value="1"></el-option>
						<el-option label="鍚? :value="0"></el-option>
					</el-select>
				</el-form-item>
				<el-form-item v-else class="input" label="鏄惁鍒犻櫎" prop="delflag" >
					{{ruleForm.delflag==1?'鏄?:'鍚?}}
				</el-form-item>
			</template>
			<el-form-item v-if="type!='info'" class="editorBox" label="甯栧瓙鍐呭" prop="content" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.content" label="甯栧瓙鍐呭" prop="content"  class="textBox">
	...
	export default {
		data() {
			...
			return {
				...
				rules: {
					...
					content: [
						{ required: true, message: '甯栧瓙鍐呭涓嶈兘涓虹┖', trigger: 'blur' },
					],
					parentid: [
					],
					username: [
		...
		methods: {
			...
			init(id,type ) {
				...
				this.isdoneOptions = "寮€鏀?鍏抽棴".split(',')
