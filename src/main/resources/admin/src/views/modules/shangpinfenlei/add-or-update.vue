...
<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="鍟嗗搧鍒嗙被" prop="shangpinfenlei" >
					<el-input v-model="ruleForm.shangpinfenlei" placeholder="鍟嗗搧鍒嗙被" clearable  :readonly="ro.shangpinfenlei"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鍟嗗搧鍒嗙被" prop="shangpinfenlei" >
					<el-input v-model="ruleForm.shangpinfenlei" placeholder="鍟嗗搧鍒嗙被" readonly></el-input>
				</el-form-item>
			</template>
