	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="鐢ㄦ埛鎿嶄綔" prop="operation" >
					<el-input v-model="ruleForm.operation" placeholder="鐢ㄦ埛鎿嶄綔" clearable  :readonly="ro.operation"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鐢ㄦ埛鎿嶄綔" prop="operation" >
					<el-input v-model="ruleForm.operation" placeholder="鐢ㄦ埛鎿嶄綔" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="璇锋眰鏂规硶" prop="method" >
					<el-input v-model="ruleForm.method" placeholder="璇锋眰鏂规硶" clearable  :readonly="ro.method"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="璇锋眰鏂规硶" prop="method" >
					<el-input v-model="ruleForm.method" placeholder="璇锋眰鏂规硶" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="璇锋眰鏃堕暱(姣)" prop="time" >
					<el-input v-model="ruleForm.time" placeholder="璇锋眰鏃堕暱(姣)" clearable  :readonly="ro.time"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="璇锋眰鏃堕暱(姣)" prop="time" >
					<el-input v-model="ruleForm.time" placeholder="璇锋眰鏃堕暱(姣)" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="IP鍦板潃" prop="ip" >
					<el-input v-model="ruleForm.ip" placeholder="IP鍦板潃" clearable  :readonly="ro.ip"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="IP鍦板潃" prop="ip" >
					<el-input v-model="ruleForm.ip" placeholder="IP鍦板潃" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="璇锋眰鍙傛暟" prop="params" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.params" label="璇锋眰鍙傛暟" prop="params"  class="textBox">
