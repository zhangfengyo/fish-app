		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="鍚嶇О" prop="name" >
					<el-input v-model="ruleForm.name" placeholder="鍚嶇О" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="鎺ㄨ崘绫诲瀷" prop="inteltype" >
					<el-input v-model="ruleForm.inteltype" placeholder="鎺ㄨ崘绫诲瀷" clearable  :readonly="ro.inteltype"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鎺ㄨ崘绫诲瀷" prop="inteltype" >
					<el-input v-model="ruleForm.inteltype" placeholder="鎺ㄨ崘绫诲瀷" readonly></el-input>
				</el-form-item>
