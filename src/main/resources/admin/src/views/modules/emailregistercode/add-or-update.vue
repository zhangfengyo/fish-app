...
<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="閭" prop="email" >
					<el-input v-model="ruleForm.email" placeholder="閭" clearable  :readonly="ro.email"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="閭" prop="email" >
					<el-input v-model="ruleForm.email" placeholder="閭" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="瑙掕壊" prop="role" >
					<el-input v-model="ruleForm.role" placeholder="瑙掕壊" clearable  :readonly="ro.role"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="瑙掕壊" prop="role" >
					<el-input v-model="ruleForm.role" placeholder="瑙掕壊" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="楠岃瘉鐮? prop="code" >
					<el-input v-model="ruleForm.code" placeholder="楠岃瘉鐮? clearable  :readonly="ro.code"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="楠岃瘉鐮? prop="code" >
					<el-input v-model="ruleForm.code" placeholder="楠岃瘉鐮? readonly></el-input>
				</el-form-item>
			</template>
		...
		data() {
			return {
				...
				rules: {
					...
					role: [
						{ required: true, message: '瑙掕壊涓嶈兘涓虹┖', trigger: 'blur' },
					],
					code: [
