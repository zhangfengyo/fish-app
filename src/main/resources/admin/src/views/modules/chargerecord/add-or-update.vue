	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="閲戦" prop="amount" >
					<el-input-number v-model="ruleForm.amount" placeholder="閲戦" :disabled="ro.amount"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="閲戦" prop="amount" >
					<el-input v-model="ruleForm.amount" placeholder="閲戦" readonly></el-input>
				</el-form-item>
			</template>
		...
		data() {
			...
			return {
				...
				rules: {
					...
					amount: [
						{ required: true, message: '閲戦涓嶈兘涓虹┖', trigger: 'blur' },
