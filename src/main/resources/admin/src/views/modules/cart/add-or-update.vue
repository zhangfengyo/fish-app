...
<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="鍟嗗搧琛ㄥ悕" prop="tablename" >
					<el-input v-model="ruleForm.tablename" placeholder="鍟嗗搧琛ㄥ悕" clearable  :readonly="ro.tablename"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鍟嗗搧琛ㄥ悕" prop="tablename" >
					<el-input v-model="ruleForm.tablename" placeholder="鍟嗗搧琛ㄥ悕" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="鍟嗗搧id" prop="goodid" >
					<el-input v-model="ruleForm.goodid" placeholder="鍟嗗搧id" clearable  :readonly="ro.goodid"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鍟嗗搧id" prop="goodid" >
					<el-input v-model="ruleForm.goodid" placeholder="鍟嗗搧id" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="鍚嶇О" prop="goodname" >
					<el-input v-model="ruleForm.goodname" placeholder="鍚嶇О" clearable  :readonly="ro.goodname"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鍚嶇О" prop="goodname" >
					<el-input v-model="ruleForm.goodname" placeholder="鍚嶇О" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="绫诲瀷" prop="goodtype" >
					<el-input v-model="ruleForm.goodtype" placeholder="绫诲瀷" clearable  :readonly="ro.goodtype"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="绫诲瀷" prop="goodtype" >
					<el-input v-model="ruleForm.goodtype" placeholder="绫诲瀷" readonly></el-input>
				</el-form-item>
			</template>
		...
		data() {
			...
			return {
				...
				rules: {
					...
					buynumber: [
						{ required: true, message: '璐拱鏁伴噺涓嶈兘涓虹┖', trigger: 'blur' },
