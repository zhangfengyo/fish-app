	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="鏀惰揣浜? prop="name" >
					<el-input v-model="ruleForm.name" placeholder="鏀惰揣浜? clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鏀惰揣浜? prop="name" >
					<el-input v-model="ruleForm.name" placeholder="鏀惰揣浜? readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="鐢佃瘽" prop="phone" >
					<el-input v-model="ruleForm.phone" placeholder="鐢佃瘽" clearable  :readonly="ro.phone"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鐢佃瘽" prop="phone" >
					<el-input v-model="ruleForm.phone" placeholder="鐢佃瘽" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="鏄惁榛樿鍦板潃[鏄?鍚" prop="isdefault" >
					<el-input v-model="ruleForm.isdefault" placeholder="鏄惁榛樿鍦板潃[鏄?鍚" clearable  :readonly="ro.isdefault"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="鏄惁榛樿鍦板潃[鏄?鍚" prop="isdefault" >
					<el-input v-model="ruleForm.isdefault" placeholder="鏄惁榛樿鍦板潃[鏄?鍚" readonly></el-input>
				</el-form-item>
			</template>
		...
		data() {
			return {
				...
				rules: {
					...
					name: [
						{ required: true, message: '鏀惰揣浜轰笉鑳戒负绌?, trigger: 'blur' },
					],
					phone: [
						{ required: true, message: '鐢佃瘽涓嶈兘涓虹┖', trigger: 'blur' },
					],
					isdefault: [
						{ required: true, message: '鏄惁榛樿鍦板潃[鏄?鍚涓嶈兘涓虹┖', trigger: 'blur' },
					],
				},
			};
		},
